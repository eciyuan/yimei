...
(function(){
	...
	}function showSubscribeTipsHandle(opts){
		if(opts.qrcode.length>5){
			var tempHtml = $('<div class="shareTips"><div class="tips_concern_handle"></div><div class="qrcode"><img src="'+opts.qrcode+'"/><p>长按二维码关注公众号</p></div><a class="close" href="javascript:;"></a></div>');
		}else{
			var tempHtml = $('<div class="shareTips"><div class="tips_concern_handle"></div><a class="close" href="javascript:;"></a></div>');
		}
		$('body').append(tempHtml);
		$('.shareTips').click(function(){
			$('.shareTips').remove();
	...
	*/
	...
	var WeiPHP = {
		...
		showSubscribeTips:showSubscribeTips,//提示关注公众号有奖
		showSubscribeTipsHandle:showSubscribeTipsHandle,//提示关注公众号后才操作
