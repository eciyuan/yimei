...
return array(
       ...
       'DB_NAME'   => 'study', // 数据库名
       // 'DB_NAME'   => 'WWW834769yimei', // 数据库名
    	//  'DB_PWD'    => 'WWWeciyuannet123', // 密码     
    	 'DB_USER'   => 'root', // 用户名
     	 'DB_PWD'    => '19951020',  // 密码
        'DB_PORT'   => '3306', // 端口
        'DB_PREFIX' => 'yimei_', // 数据库表前缀
		'DB_PARAMS' => array (
				\PDO::ATTR_CASE => \PDO::CASE_NATURAL 
		),
		
		// 系统数据加密设置
		'DATA_AUTH_KEY' => 'yh=P*DCaB(r;jfH!<i@R#49%^WJ5Q]X-U:wV~|Me', // 默认数据加密KEY
		...
		//'EDITOR_PICTURE_UPLOAD_DRIVER' => 'tWYLY-2osMHxrLBR2lTPexHtCcQ89XR8mZYJXaV4',		
