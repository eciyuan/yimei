...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?>|伊媒微时代后台管理平台</title>
    <link href="/yimei/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/yimei/Public/Admin/css/base.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/yimei/Public/Admin/css/common.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/yimei/Public/Admin/css/module.css?v=<?php echo SITE_VERSION;?>" />
    <link rel="stylesheet" type="text/css" href="/yimei/Public/Admin/css/style.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/yimei/Public/Admin/css/store.css?v=<?php echo SITE_VERSION;?>" media="all">
	<link rel="stylesheet" type="text/css" href="/yimei/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css?v=<?php echo SITE_VERSION;?>" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/yimei/Public/Admin/js/jquery.mousewheel.js?v=<?php echo SITE_VERSION;?>"></script>
    <!--<![endif]-->
...
<body>
    ...
    <div class="header">
        ...
        <span class="logo" style="float: left;margin-left: 2px;width: 50px;height: 49px;background:url('<?php echo C('SYSTEM_LOGO');?>') no-repeat " >
        
        <?php }else{ ?>
        <span class="logo" style="float: left;margin-left: 2px;width: 50px;height: 49px;background:url('/Public/Home/images/logo.png') no-repeat 0 -22px" >
...
<!--         <img style="height:49px;" src="/weiphp3.0/Public/Home/images/logo.png"> -->
    ...
    <!-- /内容区 -->
    <script type="text/javascript">
	var  IMG_PATH = "/yimei/Public/Admin/images";
    ...
    <script type="text/javascript" src="/yimei/Public/static/think.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript" src="/yimei/Public/Admin/js/common.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript">
        +function(){
	...
	<?php if(isset($data)): ?><script type="text/javascript" src="/yimei/Public/static/jquery.dragsort-0.5.1.min.js"></script><?php endif; ?>
	<script type="text/javascript">
		$(function(){
			//导航高亮
