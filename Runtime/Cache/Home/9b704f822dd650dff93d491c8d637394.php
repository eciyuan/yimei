...
<div class="login_header">
    <div class="log_wrap">
        <a href="/" title="WeiPHP"><img class="logo" src="/yimei/Public/Home/images/logo.png"/></a>
        <!--
        <div class="nav_r">
...
<section class="reg_box log_wrap">
	<form class="login-form fl" action="/yimei/index.php?s=/Home/User/register.html" method="post">
    	<h3>注册WeiPHP账号</h3>
       ...
       <div class="form_body">
            ...
            <div class="controls">
              ...
              <span class="tips">用于登录亿次元科技微信公众号管理系统</span>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <span class="tips">用于发送公众号管理相关资料</span>
            </div>
          </div>
          <div class="control-group">
    ...
    <p class="copyright">本系统由<a href="http://weiphp.cn" target="_blank">亿次元科技</a>开发</p>
</div>
