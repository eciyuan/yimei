...
<div id="content"  <?php if($bgurl != NULL): ?>style="background:url('<?php echo (get_cover_url($bgurl)); ?>') repeat-y center 0"<?php endif; ?>>
    ...
    <section class="banner"  id="banner">
	  ...
	  <div class="block_title mb10">
	  	<div class="theme textC">
	  		...
	  		<span>访问</span>&nbsp;&nbsp;<span id="visitValue"></span>
...
function gacCount() {
    ...
    url="<?php echo addons_url('Weiba://Wap/getNewNumber',array('p'=>2));?>";//社区2的数据 
    $.ajax({
    	cache:false,
        url: url,      
