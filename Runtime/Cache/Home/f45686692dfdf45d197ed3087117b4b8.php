...
(function(){
  ...
  $(function(){
   ...
   var _id =$('#nid').find('input').val();
	function addPost(){
		var $postHtml = $('<div class="chooseShopDialog"><ul><center><img src="/yimei/Public/Home/images/loading.gif"/></center></ul><br/><div class="m15"><a href="javascript:;" class="btn" id="confirmBtn">确定</a></div></div>');
		$.Dialog.open("选择帖子",{width:600,height:500},$postHtml);
		
		$.ajax({
	  		url:"<?php echo addons_url('Weiba://Post/post_data');?>",
	  		data:{},
	  		dataType:'JSON',
