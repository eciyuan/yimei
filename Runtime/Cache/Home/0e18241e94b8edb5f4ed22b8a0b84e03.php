    	...
    	<div class="order_detail">
            ...
            <div class="address_info">
             ...
             <div class="action_wrap">
            	<?php if($info[pay_status]==0): ?><p class="wait_pay">等待买家付款中...</p>
                	 <?php elseif($info[pay_status]==4): ?>
                  	  <a class="btn submit-btn" onClick="confirmPayStatus('<?php echo U('confirmPayStatus',array('order_id'=>$info.id,'pay_status'=>'4'));?>');">确认收款</a>
                <?php else: ?>
                	<?php if(($info[is_send]) == "0"): ?><p><?php if(($info["pay_type"]) == "10"): ?>买家选择到店自提<?php else: ?>买家已付款<?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn" href="javascript:;" onClick="$('#sendDiv').show();$(this).parent().hide()">发货</a></p>
                    ...
                    <?php else: ?>
                        ...
                        <?php if($info[pay_type]==10 and $info['pay_status']==0): ?><p>此订单为到店自提，如果您已经收到款项，请点击：&nbsp;&nbsp;&nbsp;<a href="javascript:;" onClick="doPay();">确认已经收款</a></p><?php endif; endif; endif; ?><!--支付状态  -->
            </div>
        </div>
    </div>
  </section>
...
function confirmPayStatus(url){
	if(confirm('确认改变订单当前的状态？')){
