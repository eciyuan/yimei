	...
	<div  class="mui-content">
        <div class="translate">
          <!--  <div class="mui-card" >
            ...
            <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="mui-card">
                <div class="mui-card-header">
                    关于问候语的翻译，用阿拉伯语，想试试吗？
                </div>
            <div class="mui-card-content">
                <div class="mui-row">
                    <div class="docs-sub-content">
                         <p class="page-description">Once you've downloaded mui, here's what to do next.Once you've downloaded mui, here's what to do next</p>
                           <?php if($vo["translation_type"] == 1): ?><img class="mui-media-object mui-pull-left" src="../images/shuijiao.jpg">
                                <?php else: endif; ?>
                        <p><span>166</span>个译文&nbsp;&nbsp;&nbsp;&nbsp;<span>1626<i class="mui-icon mui-icon-person"></i></span></p>
            ...
            <div class="mui-card-footer">
                <div class="mui-row">
                    <div class=" mui-col-xs-6">
                        <?php if($vo["pay_type"] == 1): ?><a  href="" class="mui-btn"><span><i class="mui-icon mui-icon-help"></i></span>帮他翻译</a>
                            <?php else: ?>
                            <a href="" class="mui-btn"><span><i class="mui-icon mui-icon-help"></i></span>查看译文</a><?php endif; ?>
                    </div>
                    <div class=" mui-col-xs-6">
                        <a  href="" class="mui-btn"><i class="mui-icon mui-icon-plusempty"></i>邀请翻译</a>
                    </div>
                </div>
            </div>
