...
<meta charset="utf-8">
  ...
  <script src="<?php echo ADDON_PUBLIC_PATH;?>/iscroll5.2.js?v=<?php echo SITE_VERSION;?>"></script>
    ...
    <script type="text/javascript" src="/yimei/Public/Home/js/m/flipsnap.min.js"></script>
<script>
/**
 * 全局变量
 */
              ...
              <div class="upload_img_wrap">
                 <div class="controls">
                    <div class="upload_row muti_picture_row">
                        ...
                        <?php if(!empty($data[$field['name']])): $tempArr = explode(',',$data['img_ids']); for($i=0;$i<count($tempArr);$i++){ echo '<div class="img_item"><em>X</em><input type="hidden" name="img_ids[]" multiple value="'.$tempArr[$i].'"/><img src="'.get_cover_url($tempArr[$i]).'"/></div>'; } endif; ?>
                        <a class="img_item add_btn" href="javascript:;" onClick="$.WeiPHP.wxChooseImg(this,1,'img_ids[]')"><img width="100%" src="/yimei/Public/Home/images/add.png"/></a>
                    </div>
                  </div>
              </div>
          </div>
