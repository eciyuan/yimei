...
class CommonSessionController extends AddonsController {
	var $model;
	function _initialize() {
		$this->model = $this->getModel ( 'translation_commonSession' );
		parent::_initialize ();
	...
	public function lists() {
		...
		$isAjax = I ( 'isAjax' );
		$isRadio = I ( 'isRadio' );
		$model = $this->getModel ( 'translation_commonSession' );
		...
		$dao = D ( 'translation_commonSession' );
		/* 查询记录总数 */
		$count = M ( $name  )->count ();
