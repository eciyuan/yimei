...
class HumanTranslationController extends AddonsController{
    ...
    public function config() {
        ...
        $normal_tips = '在微信里回复“人工翻译”即可以查看效果,也可以点击：<a href="' . addons_url ( 'HumanTranslation://HumanTranslation/preview', array (
                'publicid' => $public_info ['id']
            ) ) . '">预览</a>， <a id="copyLink" data-clipboard-text="' . addons_url ( 'HumanTranslation://Wap/index', array (
                'publicid' => $public_info ['id']
    ...
    function preview() {
        $id = I ( 'id', 0, 'intval' );
        $url = addons_url ( 'HumanTranslation://Wap/index', array (
            'id' => $id,
            'invite_uid' => $this->mid
        ) );
        $this->assign ( 'url', $url );
