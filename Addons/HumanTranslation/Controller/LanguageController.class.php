...
class LanguageController extends AddonsController {
	var $model;
	function _initialize() {
		$this->model = $this->getModel ( 'translation_language' );
		parent::_initialize ();
	...
	public function lists() {
		...
		$isAjax = I ( 'isAjax' );
		$isRadio = I ( 'isRadio' );
		$model = $this->getModel ( 'translation_language' );
